...
int main() {
  using graph = Graph<Vertex<0, Edge<0, 1>>, Vertex<1, Edge<1, 2>, Edge<1, 5>>,
                      Vertex<2, Edge<2, 3>, Edge<2, 0>>, Vertex<3, Edge<3, 4>>,
                      Vertex<4, Edge<4, 1>>, Vertex<5, Edge<5, 4>>>;
  ...
  */
  ...
  using graph_1 =
      Graph<Vertex<0, Edge<0, 1>, Edge<0, 3>>, Vertex<1, Edge<1, 2>>,
            Vertex<2, Edge<2, 0>>, Vertex<3>, Vertex<4, Edge<4, 5>>,
            Vertex<5, Edge<5, 6>, Edge<5, 7>>, Vertex<6, Edge<6, 4>>,
            Vertex<7, Edge<7, 8>>, Vertex<8, Edge<8, 9>>, Vertex<9, Edge<9, 7>>,
            Vertex<10>, Vertex<11, Edge<11, 10>, Edge<11, 0>, Edge<11, 1>>>;
  ...
  using graph_2 =
      Graph<Vertex<0, Edge<0, 2>, Edge<0, 3>>, Vertex<1, Edge<1, 0>>,
            Vertex<2, Edge<2, 1>>, Vertex<3, Edge<3, 4>>,
            Vertex<4, Edge<4, 5>, Edge<4, 6>>, Vertex<5>,
            Vertex<6, Edge<6, 5>>>;
