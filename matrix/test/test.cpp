...
bool TossCoin() { return RandomUInt(1) == 0; }
...
int main(int argc, char** argv) {
  {
    ...
    ASSERT_EXCEPTION_MSG(mat.set(0, 1, 10.), task::OutOfBoundsException,
                         "set()")
    ...
    ASSERT_TRUE_MSG(mat[0][0] == 1. && mat[0][1] == 0. && mat[1][0] == 0. &&
                        mat[1][1] == 0.,
                    "resize()")
  ...
  REPEAT(10) {
    ...
    ASSERT_EXCEPTION_MSG(mat1 * mat2, task::SizeMismatchException,
                         "Exceptions");
    ASSERT_EXCEPTION_MSG(mat1 *= mat2, task::SizeMismatchException,
                         "Exceptions");
    ...
    ASSERT_EXCEPTION_MSG(mat1.trace(), task::SizeMismatchException,
                         "Exceptions");
  }
  ...
  REPEAT(100) {
    ...
    mat2[RandomUInt(0, rows - 1)][RandomUInt(0, cols - 1)] +=
        TossCoin() ? EPS / 2 : -EPS / 2;
